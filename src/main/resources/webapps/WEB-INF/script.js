...
// Функция обновления сводки расходов по данным
...
function showAddedMessage() {
	window.message("Добавлено");

}


// Функция для добавления новой записи в набор данных и таблицу расходов
function addItem() {
...
// Функция для загрузки всех записей в таблицу расходов
...
// Функция для удаления определенной записи
function del(el) {
	remove();
